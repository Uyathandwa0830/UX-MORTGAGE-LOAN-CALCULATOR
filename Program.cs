...
namespace ConsoleApp11
{
    internal class Program
    {
        ...
        public static int menuStart()
        {
            ...
            Console.WriteLine("Enter 1 to start  or 0 to exit:");
        ...
        {
            Console.WriteLine("WELCOME TO MORTGAGE CALCULATOR.");
            ...
            while (menuRunning)
            {
                ...
                else if (entry1 == 4)
                {
                    ...
                    foreach (var entry in schedule)
                    {
                        ...
                        //"awesome" represents a number as a currency value with two digits after the decimal point
        ...
        class MortageCalculator
        {
            static void Main(string[] args)
            {
                ...
                if (startint == 0)
                {
                    ...
                    Console.WriteLine("You will exit the app."); // Press 0 to exit
                    System.Environment.Exit(0);
                }
